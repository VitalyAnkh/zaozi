      ...
      test("Load Dialect"):
        ...
        test("Create CirctModule"):
          ...
          test("Expression"):
            ...
            test("Constant"):
              test("Signed"):
                summon[ConstantApi].op(-BigInt("deadbeafdead", 16), true, unknownLocation).operation.appendToBlock()

              test("Unsigned"):
                summon[ConstantApi].op(BigInt("beafdeadbeaf", 16), false, unknownLocation).operation.appendToBlock()
