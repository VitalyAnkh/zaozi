...
package me.jiuyang.zaozi.mlirlib
...
given ContextApi with
  ...
  extension (context: Context)
    ...
    def sizeOf:    Int           = org.llvm.circt.MlirContext.sizeof().toInt
end given

given DialectHandleApi with
  extension (dialectHandle: DialectHandle)
    def segment: MemorySegment = dialectHandle._segment
    def sizeOf:  Int           = org.llvm.circt.MlirDialectHandle.sizeof().toInt
end given
...
given LocationApi with
  ...
  extension (location: Location)
    ...
    def sizeOf:  Int           = org.llvm.circt.MlirLocation.sizeof().toInt
    def getAttribute(
      using arena: Arena
    ): Attribute =
...
given ModuleApi with
  ...
  extension (module: Module)
    ...
    def sizeOf:    Int           = org.llvm.circt.MlirModule.sizeof().toInt
    def getBody(
      using arena: Arena
...
given StringRefApi with
  extension (stringRef: StringRef)
    ...
    def sizeOf:        Int           = org.llvm.circt.MlirStringRef.sizeof().toInt
    def toBytes:       Array[Byte]   =
      org.llvm.circt.MlirStringRef
        .data$get(stringRef.segment)
        .asSlice(0, org.llvm.circt.MlirStringRef.length$get(stringRef.segment))
...
given OperationStateApi with
  ...
  extension (operationState:       OperationState)
    ...
    def sizeOf:                      Int           = org.llvm.circt.MlirOperationState.sizeof().toInt
    def addAttributes(
...
given OperationApi with
  ...
  extension (operation:      Operation)
    ...
    def sizeOf:  Int           = org.llvm.circt.MlirOperation.sizeof().toInt
    def getResult(
      i:           Int
    )(
      using arena: Arena
...
given BlockApi with
  ...
  extension (block: Block)
    ...
    def sizeOf:  Int           = org.llvm.circt.MlirBlock.sizeof().toInt
...
given IdentifierApi with
  ...
  extension (identifier:       Identifier)
    ...
    def sizeOf:  Int           = org.llvm.circt.MlirIdentifier.sizeof().toInt
end given
...
given NamedAttributeApi with
  ...
  extension (namedAttribute: NamedAttribute)
    ...
    def sizeOf:  Int           = org.llvm.circt.MlirNamedAttribute.sizeof().toInt
end given
...
given AttributeApi with
  ...
  extension (attribute: Attribute)
    ...
    def sizeOf:      Int           = org.llvm.circt.MlirAttribute.sizeof().toInt
...
given ValueApi with
  extension (value: Value)
    ...
    def sizeOf:  Int           = org.llvm.circt.MlirValue.sizeof().toInt
end given
...
given TypeApi with
  ...
  extension (tpe:   Type)
    ...
    def sizeOf:  Int           = org.llvm.circt.MlirType.sizeof().toInt
end given
...
given RegionApi with
  ...
  extension (region: Region)
    ...
    def sizeOf:  Int           = org.llvm.circt.MlirRegion.sizeof().toInt
